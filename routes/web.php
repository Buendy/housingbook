...
Route::prefix('dashboard')->group(function(){
    ...
    Route::prefix('apartment')->group(function() {
        ...
        Route::delete('photodelete','dashboard\ApartmentController@photodestroy')->name('apartment.deletephotos');
        Route::delete('delete','dashboard\ApartmentController@destroy')->name('apartment.deleteapartment');
